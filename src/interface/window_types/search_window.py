...
class PropertySearchWindow(SearchWindow):

    title = "Search Property"
    search_type = "location id"
    item = "property"

    field = Field(name="Location", field="location_id")

    def submit(self) -> UUID:
        property = api.properties.all(search = self.value)
